...
use App\Exports\SummaryExport; // <-- Tambahan
...
class ReportController extends Controller
{
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('reports.print-pdf', compact('summary')); // <-- Diperbaiki
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(new SummaryExport($summary), 'summary-report.xlsx'); // <-- Diperbaiki
    }
