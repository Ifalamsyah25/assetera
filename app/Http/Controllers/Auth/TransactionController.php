            ...
            'summary' => [
                ...
                'late' => $transactions
                    ...
                    ->filter(function ($transaction) {
                        // Perbaikan di sini: Konversi string tanggal ke Carbon Object sebelum menggunakan method lt()
                        return \Carbon\Carbon::parse($transaction->borrowed_at)->lt(now()->subDays(7));
                    })
                    ->count(),
            ],
            'filters' => [
